...
class Config:
    ...
    ADMIN = os.environ.get("ADMINS", '1281282633')
...
__Example: To set up a__ `REPLY_MESSAGE` __use__ `/env REPLY_MESSAGE=Hey, Check out @HeartBeat_Muzic rather than spamming in my PM`__
