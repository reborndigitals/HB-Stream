# Copyright (C) @subinps
# Update By (C) @rajeshrakis
# Channel : https://t.me/HeartBeat_Muzic
...
async def repo_(client, message):
    ...
    await message.reply("<b>The source code of HB-Stream is public and can be found at <a href=https://t.me/HeartBeat_Offi>Github.</a> You can deploy your own bot and use in your group.\n\nFeel free to star☀️ the repo if you liked it 🙃.</b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True, quote=False)
    await delete_messages([message])
...
async def get_logs(client, message):
    ...
    if os.path.exists("botlog.txt"):
        markup = InlineKeyboardMarkup([[InlineKeyboardButton("Update Channel ✅", url="https://t.me/HeartBeat_Muzic")]])
